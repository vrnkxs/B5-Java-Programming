...
public class SubStringMethod {
    public static void main(String[] args) {
        ...
        System.out.println(day.substring(0)); //give me the option starting from index 0 until end
        System.out.println(day.substring(1)); //give me the option starting from index 1 until end
        System.out.println(day.substring(2)); //give me the option starting from index 2 until end
        System.out.println(day.substring(3)); //give me the option starting from index 3 until end
