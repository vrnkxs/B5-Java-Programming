...
public class ReplaceMethod {
    public static void main(String[] args) {
        ...
        sentence = sentence.replace("wednesday", "thursday"); //find ALL "wednesday" and replace it with "thursday"
        System.out.println("After .replace(): " + sentence);

        sentence = sentence.replace("Wednesday", "Thursday");
        System.out.println("After .replace(): " + sentence); //find ALL "Wednesday" and replace it with "Thursday"
        ...
        sentence2 = sentence2.replaceFirst("Wednesday", "Thursday"); //find FIRST "Wednesday" and replace it with "Thursday"
        System.out.println("Before .afterFirst(): " + sentence2);
