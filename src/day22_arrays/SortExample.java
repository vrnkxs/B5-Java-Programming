...
public class SortExample {
    public static void main(String[] args) {
        ...
        int [] sortedNums = nums; //did not create a new array, just pointed to the same one
        ...
        System.out.println("--------------------------------------");
        int [] num2 = new int[ nums.length ]; //created new array with the same size as nums array

        for (int i = 0; i < nums.length; i++) { //with the loop I copied all the elements from nums array into num2 array
            num2[i] = nums[i];
        }
        System.out.println("After creating a new array and making copy of num array: " + Arrays.toString(num2));
