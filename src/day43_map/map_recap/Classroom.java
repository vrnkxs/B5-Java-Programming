...
public class Classroom {
    public static void main(String[] args) {
        ...
        //when adding, it checks if there is existing key. if yes, update VALUE links to that KEY. if not, add new KEY-VALUE pair
        System.out.println(map.get(3));
        ...
        loopcampGroups.put("GP2", group2);
        loopcampGroups.put("GP3", group3);

        System.out.println(loopcampGroups);

        //can you find me the names from group 2 which contains "n" (through map)
        for (String eachNameInGroup2 : loopcampGroups.get("GP2")) {
