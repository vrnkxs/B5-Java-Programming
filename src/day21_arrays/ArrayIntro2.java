...
public class ArrayIntro2 {
    public static void main(String[] args) {
        ...
        arr1 = new double[4]; //assigned value to array that will hold 4 elements  //default -> 0.0

        //With directly giving values we cannot declare and then give values
        //double [] arr2;
        //arr2 = {32.3, 78.9};
        int num = 5;
        double [] arr2 = {32.3, 78.9, 7, num};  //double can hold int - implicit conversion (casting)
        //int [] arr3 = {32.3, 78.9, 7};  //int cannot hold double - not implicit conversion (casting)
        int [] arr3 = {(int)32.3, (int)78.9, 7}; //int cannot hold double - but with explicit conversion (casting) we handle it

        System.out.println(arr1.length); //4
        System.out.println(arr2.length); //2

        System.out.println();
        System.out.println(Arrays.toString(arr1)); //since I have made an array of 4 elements, with no initial value, it will show the default values of that data type
        System.out.println(Arrays.toString(arr2));
        System.out.println(Arrays.toString(arr3));

        System.out.println();
        //Q: Once I have made an array and declared that it wil hold 4 elements, now I want to assign values tp those locations
        //[0.0, 0.0, 0.0, 0.0]
        //  1    2    3    4
